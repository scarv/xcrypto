...
\XCINSTR{MV2GPR}{rd, crs1}{
  ...
  $\GPR[*][{\VERB[RV]{rd}}] \ASN \CPR[*][{\VERB[RV]{crs1}}]$\;
}
...
\XCINSTR{MV2COP}{crd, rs1}{
  ...
  $\CPR[*][{\VERB[RV]{crd}}] \ASN \GPR[*][{\VERB[RV]{rs1}}]$\;
}
...
\XCINSTR{CMOV.cr}{crd, crs1, crs2}{
  ...
  Conditionally move one $\CPR$ register to another.
}{
  \If{$\CPR[*][{\VERB[RV]{crs2}}] =    0$}{
    $\CPR[*][{\VERB[RV]{crd}}] \ASN \CPR[*][{\VERB[RV]{crs1}}]$\;
  }
}
...
\XCINSTR{LBU.cr}{crd, h, b, imm11(rs1)}{
  ...
  into a specific     byte of a $\CPR$ register,
  leaving the other     bytes in said register un-modified.
}{
  $addr                                                                    \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS \VERB[RV]{cd}} \ASN \MEM[*][{addr  }]$ \;
}
...
\XCINSTR{LHU.cr}{crd, h,    imm11(rs1)}{
  ...
  into a specific halfword of a $\CPR$ register,
  leaving the other halfword  in said register un-modified.
}{
  $addr                                                                    \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS             0} \ASN \MEM[*][{addr+0}]$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS             1} \ASN \MEM[*][{addr+1}]$ \;
}
...
\XCINSTR{LW.cr}{crd,        imm11(rs1)}{
  ...
  $addr                                                                    \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                0} \ASN \MEM[*][{addr+0}]$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                1} \ASN \MEM[*][{addr+1}]$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                2} \ASN \MEM[*][{addr+2}]$ \;
  $\INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                3} \ASN \MEM[*][{addr+3}]$ \;
}
...
\XCINSTR{SB.cr}{rs2, h, b, imm11(rs1)}{
  ...
  Store a specific     byte of a $\CPR$ register into memory.
  Note that
  $
  ...
  $addr            \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\MEM[*][addr  ] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS \VERB[RV]{cd}}$ \;
}
...
\XCINSTR{SH.cr}{rs2, h,    imm11(rs1)}{
  ...
  Store a specific halfword of a $\CPR$ register into memory.
  Note that
  $
  \VERB[RV]{imm11} = \VERB[RV]{imm11hi} \CONS \VERB[RV]{imm11lo} .
  $
  ...
  $addr            \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\MEM[*][addr+0] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS             0}$ \;
  $\MEM[*][addr+1] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{\VERB[RV]{cc} \CONS             1}$ \;
}
...
\XCINSTR{SW.cr}{rs2,       imm11(rs1)}{
  ...
  Store                        a $\CPR$ register into memory.
  Note that
  $
  \VERB[RV]{imm11} = \VERB[RV]{imm11hi} \CONS \VERB[RV]{imm11lo} .
  $
 ...
 $addr             \ASN \GPR[*][{\VERB[RV]{rs1}}] + \EXT[32]{\pm}( \VERB[RV]{imm11} )$ \;
  $\MEM[*][addr+0] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                0}$ \;
  $\MEM[*][addr+1] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                1}$ \;
  $\MEM[*][addr+2] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                2}$ \;
  $\MEM[*][addr+3] \ASN \INDEX[8]{\CPR[*][{\VERB[RV]{crd}}]}{                                3}$ \;
}
...
\XCINSTR{SCATTER.b}{rs, base, offsets}{
  ...
  $addr_0                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{0}$ \;
  $addr_1                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{1}$ \;
  $addr_2                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{2}$ \;
  $addr_3                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{3}$ \;
  $\MEM[*][addr_0  ]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{0}$ \;
  $\MEM[*][addr_1  ]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{1}$ \;
  $\MEM[*][addr_2  ]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{2}$ \;
  $\MEM[*][addr_3  ]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{3}$ \;
}
...
\XCINSTR{SCATTER.h}{rs, base, offsets}{
  ...
  $addr_0                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[16]{\CPR[*][{\VERB[RV]{crs2}}]}{0}$ \;
  $addr_1                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[16]{\CPR[*][{\VERB[RV]{crs2}}]}{1}$ \;
  $\MEM[*][addr_0+0]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{0}$ \;
  $\MEM[*][addr_0+1]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{1}$ \;
  $\MEM[*][addr_1+0]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{2}$ \;
  $\MEM[*][addr_1+1]                        \ASN \INDEX[ 8]{\CPR[*][{\VERB[RV]{rs}}]}{3}$ \;
}
...
\XCINSTR{GATHER.b}{crd, rs1, crs2}{
  ...
  $addr_2                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{2}$ \;
  $addr_3                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[ 8]{\CPR[*][{\VERB[RV]{crs2}}]}{3}$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{0} \ASN \MEM[*][addr_0  ]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{1} \ASN \MEM[*][addr_1  ]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{2} \ASN \MEM[*][addr_2  ]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{3} \ASN \MEM[*][addr_3  ]$ \;
}
...
\XCINSTR{GATHER.h}{rd, rs1, crs2}{
  ...
  $addr_0                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[16]{\CPR[*][{\VERB[RV]{crs2}}]}{0}$ \;
  $addr_1                                   \ASN \GPR[*][{\VERB[RV]{rs1}}] + \INDEX[16]{\CPR[*][{\VERB[RV]{crs2}}]}{1}$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{0} \ASN \MEM[*][addr_0+0]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{1} \ASN \MEM[*][addr_0+1]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{2} \ASN \MEM[*][addr_1+0]$ \;
  $\INDEX[ 8]{\CPR[*][{\VERB[RV]{crd}}]}{3} \ASN \MEM[*][addr_1+1]$ \;
}
...
\XCINSTR{RSEED.cr}{crs1}{
  ...
  Inject (or seed) $32$-bits of entropy into the RNG, reading from a $\CPR$ register.
}{
  $\RNG \ASN \CPR[*][{\VERB[RV]{crs1}}]$ \;
}
...
\XCINSTR{RSAMP.cr}{crd}{
  ...
  Sample           $32$-bits of entropy from the RNG, writing to   a $\CPR$ register.
}{
  $\CPR[*][{\VERB[RV]{crd}}] \ASN \RNG$ \;
}
...
\XCINSTR{LLI.cr}{crd, imm16}{
  ...
  into the lower (or least-significant) halfword of a $\CPR$ register, 
  leaving the other halfword in said register un-modified.
  Note that
  $
  ...
  $\INDEX[16]{\CPR[*][{\VERB[RV]{crd}}]}{0} \ASN \VERB[RV]{imm16}$ \;
}
...
\XCINSTR{LUI.cr}{crd, imm16}{
  ...
  Load an immediate halfword
  into the upper (or  most-significant) halfword of a $\CPR$ register, 
  leaving the other halfword in said register un-modified.
  Note that
  $
  \VERB[RV]{imm16} = \VERB[RV]{imm11} \CONS \VERB[RV]{imm5} .
...
%into only a single halfword.}
  ...
  $\INDEX[16]{\CPR[*][{\VERB[RV]{crd}}]}{1} \ASN \VERB[RV]{imm16}$ \;
}
...
%}
  ...
  \For{$i = 0$ {\bf upto} $31$} {
    $index \ASN \INDEX{\CPR[*][crs1]}{i} \CONS \INDEX{\CPR[*][crs2]}{i}$ \;
    $\INDEX{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX{\VERB[RV]{lut4}}{index}$ \;
  }
}
...
%instruction.}
  ...
  $t \ASN \CPR[*][{\VERB[RV]{crs1}}] \OP[32][u]{\RRT}   \VERB[RV]{shamt}       $ \;
  \For{$i = 0$ {\bf upto} $31$}{
    \eIf{$\INDEX{\CPR[*][{\VERB[RV]{rs2}}]}{i} = 0$}{
      $\INDEX{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX{t}{i}$
    }{
      $\INDEX{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX{\CPR[*][{\VERB[RV]{crd}}]}{i}$
    }
  }
}
...
%instruction.}
  ...
  $t \ASN \CPR[*][{\VERB[RV]{crs1}}] \OP[32][u]{\RRT} ( \VERB[RV]{shamt} + 16 )$ \;
  \For{$i = 0$ {\bf upto} $31$}{
    \eIf{$\INDEX{\CPR[*][{\VERB[RV]{rs2}}]}{i} = 0$}{
      $\INDEX{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX{t}{i}$
    }{
...
%No overflow conditions are tested for, and \ASM{ADD.px} raises no exceptions.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{+}      \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i}$ \;
  }
}
...
%No overflow conditions are tested for, and \ASM{MUL.px} raises no exceptions.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\times} \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i}$ \;
  }
}
...
%{\em implementation dependent}.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\LSH}   \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i}$ \;
  }
}
...
%{\em implementation dependent}.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\LSH}   \VERB[RV]{cshamt}$ \;
  }
}
...
%{\em implementation dependent}.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\RSH}   \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i}$ \;
  }
}
...
%{\em implementation dependent}.
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\RSH}   \VERB[RV]{cshamt}$ \;
  }
}
...
%(for \ASM{ROT.px}).
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\LRT}   \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i}$ \;
  }
}
...
%(for \ASM{ROT.px}).
  ...
  $w \ASN \VERB[RV]{ca} \CONS \VERB[RV]{cb} \CONS \VERB[RV]{cc}$\;
  \For{$i = 0$ {\bf upto} $( 32 / w ) - 1$}{
    $\INDEX[w]{\CPR[*][{\VERB[RV]{crd}}]}{i} \ASN \INDEX[w]{\CPR[*][{\VERB[RV]{crs1}}]}{i} \OP[w][u]{\LRT}   \VERB[RV]{cshamt}$ \;
  }
}
...
%                      \CPR[*][crs1][15: 8],
%                      \CPR[*][crs1][ 7: 0]}$\\
%    $ \CPR[*][{\VERB[RV]{crd}}] \ASN bytes[\VERB[RV]{b3}] \CONS
...
%$ \CPR[*][{\VERB[RV]{crd}}][15: 0] \ASN nibbles[\VERB[RV]{b3}] \CONS
%                               nibbles[\VERB[RV]{b2}] \CONS
%                               nibbles[\VERB[RV]{b1}] \CONS
%                               nibbles[\VERB[RV]{b0}] $ \\
%$ \CPR[*][{\VERB[RV]{crd}}][31:16] \ASN \CPR[*][\VERB[RV]{crs1}][31:16]$ \\
%}
%\item \INST{TWID.N1 crd, crs1, b0, b1, b2, b3}{
%$ \CPR[*][{\VERB[RV]{crd}}][15: 0] \ASN \CPR[*][\VERB[RV]{crs1}][15: 0]$ \\
%$ \CPR[*][{\VERB[RV]{crd}}][31:16] \ASN nibbles[\VERB[RV]{b3}] \CONS
%                               nibbles[\VERB[RV]{b2}] \CONS
%                               nibbles[\VERB[RV]{b1}] \CONS
%                               nibbles[\VERB[RV]{b0}] $ \\
%}
...
%$ \CPR[*][{\VERB[RV]{crd}}][ 7: 0] \ASN crumbs[\VERB[RV]{b3}] \CONS
%                                  crumbs[\VERB[RV]{b2}] \CONS
%                                  crumbs[\VERB[RV]{b1}] \CONS
%                                  crumbs[\VERB[RV]{b0}] $ \\
%$ \CPR[*][{\VERB[RV]{crd}}][31: 8] \ASN \CPR[*][\VERB[RV]{crs1}][31: 8]$\\
%}
%\item \INST{TWID.C1 crd, crs1, b0, b1, b2, b3}{
%$ \CPR[*][{\VERB[RV]{crd}}][ 7: 0] \ASN \CPR[*][\VERB[RV]{crs1}][ 7: 0]$\\
%$ \CPR[*][{\VERB[RV]{crd}}][15: 8] \ASN crumbs[\VERB[RV]{b3}] \CONS
%                                  crumbs[\VERB[RV]{b2}] \CONS
%                                  crumbs[\VERB[RV]{b1}] \CONS
%                                  crumbs[\VERB[RV]{b0}] $ \\
%$ \CPR[*][{\VERB[RV]{crd}}][31:16] \ASN \CPR[*][\VERB[RV]{crs1}][31:16]$\\
...
%$ \CPR[*][{\VERB[RV]{crd}}][15: 0] \ASN \CPR[*][\VERB[RV]{crs1}][15: 0]$\\
%$ \CPR[*][{\VERB[RV]{crd}}][23:16] \ASN crumbs[\VERB[RV]{b3}] \CONS
%                                  crumbs[\VERB[RV]{b2}] \CONS
%                                  crumbs[\VERB[RV]{b1}] \CONS
%                                  crumbs[\VERB[RV]{b0}] $ \\
%$ \CPR[*][{\VERB[RV]{crd}}][31:24] \ASN \CPR[*][\VERB[RV]{crs1}][31:24]$\\
%}
%\item \INST{TWID.C3 crd, crs1, b0, b1, b2, b3}{
%$ \CPR[*][{\VERB[RV]{crd}}][23: 0] \ASN \CPR[*][\VERB[RV]{crs1}][23: 0]$\\
%$ \CPR[*][{\VERB[RV]{crd}}][31:24] \ASN crumbs[\VERB[RV]{b3}] \CONS
%                                  crumbs[\VERB[RV]{b2}] \CONS
%                                  crumbs[\VERB[RV]{b1}] \CONS
%                                  crumbs[\VERB[RV]{b0}] $ \\
%}
...
\XCINSTR{ADD2.mp}{(crd2, crd1), crs1, crs2      }{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crs1}}] \OP[32]{u}{+} \CPR[*][{\VERB[RV]{crs2}}] )$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[64:32]$ \;
}
...
\XCINSTR{ACC1.mp}{(crd2, crd1), crs1      }{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crd2}}] \CONS \CPR[*][{\VERB[RV]{crd1}}] ) \OP[{64}]{u}{+} \CPR[*][{\VERB[RV]{crs1}}]$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[64:32]$ \;
}
...
\XCINSTR{MAC.mp}{(crd2, crd1), crs1, crs2, crs3}{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crs1}}] \OP[32]{u}{\cdot} \CPR[*][{\VERB[RV]{crs2}}] ) 
                                                                \OP[32]{u}{+}     \CPR[*][{\VERB[RV]{crs3}}]$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[64:32]$ \;
}
...
\XCINSTR{SLL.mp}{(crd2, crd1), crs1, crs2, crs3}{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crs1}}] \CONS \CPR[*][{\VERB[RV]{crs2}}] ) \LSH \CPR[*][{\VERB[RV]{crs3}}]_{5:0}$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[63:32]$ \;
...
\XCINSTR{SLLI.mp}{(crd2, crd1), crs1, crs2, shamt}{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crs1}}] \CONS \CPR[*][{\VERB[RV]{crs2}}] ) \LSH shamt$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[63:32]$ \;
}
...
\XCINSTR{SRL.mp}{(crd2, crd1), crs1, crs2, crs3}{
  ...
  $t                          \ASN ( \CPR[*][{\VERB[RV]{crs1}}] \CONS \CPR[*][{\VERB[RV]{crs2}}] ) \RSH \CPR[*][{\VERB[RV]{crs3}}]_{5:0}$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[63:32]$ \;
...
\XCINSTR{SRLI.mp}{(crd2, crd1), crs1, crs2, shamt}{
  ...
  $t                          \ASN (\CPR[*][{\VERB[RV]{crs1}}] \CONS \CPR[*][{\VERB[RV]{crs2}}]) \RSH shamt$ \;
  $\CPR[*][{\VERB[RV]{crd1}}] \ASN t[31: 0]$ \;
  $\CPR[*][{\VERB[RV]{crd2}}] \ASN t[63:32]$ \;
...
\XCINSTR{EQU.mp}{rd, crs1, crs2, crs3}{
  ...
  $\GPR[*][{\VERB[RV]{rd}}] \ASN ( \CPR[*][{\VERB[RV]{crs1}}] = \CPR[*][{\VERB[RV]{crs2}}])                                                                     \AND \CPR[*][{\VERB[RV]{crs3}}]  $ \;
}
...
\XCINSTR{LTU.mp}{rd, crs1, crs2, crs3}{
  ...
  $\GPR[*][{\VERB[RV]{rd}}] \ASN ( \CPR[*][{\VERB[RV]{crs1}}] < \CPR[*][{\VERB[RV]{crs2}}] ) \IOR ( ( \CPR[*][{\VERB[RV]{crs1}}] = \CPR[*][{\VERB[RV]{crs2}}] ) \AND \CPR[*][{\VERB[RV]{crs3}}] )$ \;
}
