...
\item All cited implementation approaches are viable, but, in {\em concept},
      ...
      terminology from here on.  By doing so, we aim to present a clean(er) 
      separation between the intended roles of some host core and associated 
      \XCID co-processor.
...
\item All that said, such an approach may naturally be deemed inappropriate 
      ...
      b) many commercialised SoCs 
         ...
         prefer to couple a dedicated IP core 
