...
the high and low half-words of a word respectivley.
...
used as the destination for a multi-precision instructions. \designnote{
    ...
    or {\tt 01} depending on the even or odd address respectivley.
}
...
$t \ASN ( \GPR[*][\OPER{rs}_1] \SOP{+}{u}     \GPR[*][\OPER{rs}_2] ) + \GPR[*][\OPER{rs}_3] $\\
$\GPR[*][\OPER{rd}_1] \ASN t_{1 \cdot \W - 1, \ldots,  0}$\\
$\GPR[*][\OPER{rd}_2] \ASN t_{        \W                }$\\
}
\end{itemize}
...
$t \ASN ( \GPR[*][\OPER{rs}_1] \CONS \GPR[*][\OPER{rs}_0] ) + \GPR[*][\OPER{rs}_2] + \GPR[*][\OPER{rs}_3] $\\
$\GPR[*][\OPER{rd}_1] \ASN t_{1 \cdot \W - 1, \ldots,  0} $\\
$\GPR[*][\OPER{rd}_2] \ASN t_{2 \cdot \W - 1, \ldots, \W} $\\
}
\end{itemize}
...
$t                  \ASN ( \GPR[*][\OPER{rs}_1] \SOP{\cdot}{u} \GPR[*][\OPER{rs}_2] ) + \GPR[*][\OPER{rs}_3]$\\
$\GPR[*][\OPER{rd}_0] \ASN t_{1 \cdot \W - 1, \ldots,  0}$\\
$\GPR[*][\OPER{rd}_1] \ASN t_{2 \cdot \W - 1, \ldots, \W}$\\
}
\end{itemize}

\note{Originally this instruction was to have a fourth source register operand
which would have been added into the final accumulate. It was removed because it
did not fit sensibly into the encoding space.}

\paragraph{SLL.mp}

\begin{itemize}
\item \INST{SLL.mp (rd1, rd2), rs1, rs2, rs3     }{
$\GPR[*][\OPER{rd}_2] \ASN \GPR[*][\OPER{rs}_1] \LSH      \GPR[*][\OPER{rs}_2]_{\log_2(\W)-1 \ldots 0} \IOR \GPR[*][\OPER{rs}_3]$\\
$\GPR[*][\OPER{rd}_1] \ASN \GPR[*][\OPER{rs}_1] \RSH \W - \GPR[*][\OPER{rs}_1]_{\log_2(\W)-1 \ldots 0}$\\
}
\end{itemize}
...
$\GPR[*][\OPER{rd}_2] \ASN \GPR[*][\OPER{rs}_1] \LSH \W - \GPR[*][\OPER{rs}_2]_{\log_2(\W)-1 \ldots 0}$\\
$\GPR[*][\OPER{rd}_1] \ASN \GPR[*][\OPER{rs}_1] \RSH      \GPR[*][\OPER{rs}_2]_{\log_2(\W)-1 \ldots 0} \IOR \GPR[*][\OPER{rs}_3]$\\
}
\end{itemize}
...
$\GPR[*][\OPER{rd}_1] \ASN ( \GPR[*][\OPER{rs}_1] = \GPR[*][\OPER{rs}_2] ) \AND \GPR[*][\OPER{rs}_3]  $\\
}
\end{itemize}
...
$\GPR[*][\OPER{rd}_1] \ASN ( \GPR[*][\OPER{rs}_1] < \GPR[*][\OPER{rs}_2] ) \IOR ( ( \GPR[*][\OPER{rs}_1] = \GPR[*][\OPER{rs}_2] ) \AND \GPR[*][\OPER{rs}_3] )$
}
\end{itemize}
...
\begin{bytefield}[endianness=big]{32}
\bitheader{0-31}               \\
\BH{6}{func5  }&\BH{1}{ ? }& \BH{2}{rs3}& \BH{4}{rs2}&\BH{4}{rs1}& \BH{3}{func3}& \BH{2}{rs3}& \BH{3}{rdm}& \BH{8}{opcode}    & \BH{8}{MR-type}  \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ ADD.mp } \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ SUB.mp } \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ ACC.mp } \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ MAC.mp } \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ SLL.mp } \\
\BB{6}{ 10??? }&\BB{1}{ ? }& \BB{2}{B}& \BB{4}{rs2}&\BB{4}{rs1}& \BB{3}{ 000 }& \BB{2}{A}& \BB{3}{rdm}& \BB{8}{\encopcode}& \BB{8}{ SRL.mp } \\
\end{bytefield}

\note{For the MR-type instructions \ASM{ADD.mp}, \ASM{SUB.mp}, \ASM{ACC.mp},
\ASM{MAC.mp}, \ASM{SLL.mp} and \ASM{SRL.mp} the {\tt rs3} register address
is created by concatenating the 2-bit {\tt B} field with the 2-bit {\tt A}
field to create the 4-bit register address.}
\bigskip

\begin{bytefield}[endianness=big]{32}
\bitheader{0-31}               \\
\BH{5}{func5  }& \BH{3}{rs3}& \BH{4}{rs2}&\BH{4}{rs1}&\BH{3}{func3}& \BH{1}{rs3} &\BH{4}{rd}& \BH{8}{opcode}    & \BH{8}{MR-type}  \\
\BB{5}{ 11000 }& \BB{3}{B}& \BB{4}{rs2}&\BB{4}{rs1}&\BB{3}{ 000 }& \BB{1}{A} &\BB{4}{rd}& \BB{8}{\encopcode}& \BB{8}{ EQU.mp } \\
\BB{5}{ 11001 }& \BB{3}{B}& \BB{4}{rs2}&\BB{4}{rs1}&\BB{3}{ 000 }& \BB{1}{A} &\BB{4}{rd}& \BB{8}{\encopcode}& \BB{8}{ LTU.mp } \\
\BB{5}{ 11010 }& \BB{3}{B}& \BB{4}{rs2}&\BB{4}{rs1}&\BB{3}{ 000 }& \BB{1}{A} &\BB{4}{rd}& \BB{8}{\encopcode}& \BB{8}{ GTU.mp } \\
\end{bytefield}

\note{For the MR-type instructions \ASM{EQU.mp}, \ASM{LTU.mp} and 
\ASM{GTU.mp}, the {\tt rs3} register address is created by concatenating
the 3-bit {\tt B} field with the 1-bit {\tt A} field to create the
4-bit register address.}

\begin{bytefield}[endianness=big]{32}
\bitheader{0-31}               \\
\BH{5}{func5 }& \BH{2}{pw}& \BH{5}{rs2  }& \BH{5}{rs1  }& \BH{3}{func3}& \BH{5}{rd   }& \BH{8}{opcode}& \BH{8}{R-type} \\
\BB{5}{ 00000}& \BB{2}{pw}& \BB{5}{ rs2 }& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ ADD.px } \\
\BB{5}{ 00001}& \BB{2}{pw}& \BB{5}{ rs2 }& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ SUB.px } \\
\BB{5}{ 00010}& \BB{2}{pw}& \BB{5}{ rs2 }& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ MUL.px } \\
\BB{5}{ 00011}& \BB{2}{pw}& \BB{5}{SHAMT}& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ SLL.px } \\
\BB{5}{ 00100}& \BB{2}{pw}& \BB{5}{SHAMT}& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ SRL.px } \\
\BB{5}{ 00101}& \BB{2}{pw}& \BB{5}{SHAMT}& \BB{5}{rs1}& \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ ROT.px } \\
\end{bytefield}
\end{center}

\note{For the R-type instructions with a {\em pack-width} ({\tt pw}) field, 
this field indicates the size of the packed operation to perform. The two
bit field is decoded thus:}
\begin{itemize}
\item $0 \Rightarrow 32$ bit ops - Words.
\item $1 \Rightarrow 16$ bit ops - Halfwords.
\item $2 \Rightarrow 8$ bit ops - Bytes.
\item $3 \Rightarrow 4$ bit ops - Nibbles.
\end{itemize}
\bigskip
...
\begin{bytefield}[endianness=big]{32}
\bitheader{0-31}               \\
\BH{5}{func5 }& \BH{2}{op}& \BH{5}{rs2    }& \BH{5}{rs1  }& \BH{3}{func3}& \BH{5}{rd}& \BH{8}{opcode}& \BH{8}{R-type} \\
\BB{5}{ 00110}& \BB{2}{00}& \BB{5}{ rs2   }& \BB{5}{rs1}  & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ XORT   } \\
\BB{5}{ 00110}& \BB{2}{01}& \BB{5}{ rs2   }& \BB{5}{rs1}  & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ ANDT   } \\
\BB{5}{ 00110}& \BB{2}{10}& \BB{5}{ rs2   }& \BB{5}{rs1}  & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ ORT    } \\
\BB{5}{ 00110}& \BB{2}{11}& \BB{5}{00000  }& \BB{5}{rs1}  & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ MVCOP  } \\
\BB{5}{ 00110}& \BB{2}{11}& \BB{5}{00001  }& \BB{5}{rs1}  & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{ MVGPR  } \\
\BB{5}{ 00111}& \BB{2}{00}& \BB{5}{offsets}& \BB{5}{base} & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{GATHER} \\
\BB{5}{ 00111}& \BB{2}{01}& \BB{5}{offsets}& \BB{5}{base} & \BB{3}{ 000 }& \BB{5}{rd}& \BB{8}{\encopcode}& \BB{8}{SCATTER} \\
\end{bytefield}
\end{center}
