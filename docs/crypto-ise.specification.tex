...
\begin{itemize}
\item $ca,cb,cc = 000 \Rightarrow $ Pack width $1$
\item $ca,cb,cc = 001 \Rightarrow $ Pack width $2$
\item $ca,cb,cc = 010 \Rightarrow $ Pack width $4$
\item $ca,cb,cc = 011 \Rightarrow $ Pack width $8$
\item $ca,cb,cc = 100 \Rightarrow $ Pack width $16$
\item $ca,cb,cc = 101 \Rightarrow $ Pack width $32$
\item $ca,cb,cc = 110 $ - Reserved. Should be treated as a NOP.
\item $ca,cb,cc = 111 $ - Reserved. Should be treated as a NOP.
\end{itemize}
}{
fig:encodings-rtype
}
