...
\ASM{RMIX.cr} will rotate the the value in {\tt rs1} to the right by $0..15$,
while \ASM{LMIX.cr} will rotate to the left by the same amounts.
...
ORI.cr   c0, 0x7800     // bits 10:7 from a register
RMIX.cr  c2, c1, c0, 8  // c2[10:7] <- c1[19:15]

LUI.cr   c0, 0x0000     // Mask to select top 7 bits of 
ORI.cr   c0, 0x000E     // byte 0
LMIX.cr  c2, c1, c0, 16 // c2[7:1] <- c1[23:17]
\end{lstlisting}
