...
amenable to bitsliced implementations of cryptographic functions.
...
\designnote{
    This instruction must be implemented with care, since a naieve
...
varients allow two lookups into a 16-bit LUT stored in memory. \ASM{GATHER}
...
\designnote{
    While it is ofcourse possible to emulate the {\tt .h} varients of
    \ASM{SCATTER} and \ASM{GATHER} with the {\tt.b} varients, we felt that
