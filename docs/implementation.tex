...
\SIGNALO{32}{id\_imm}{
    ...
    \item Positions and sizes for bitfield instructions {\tt xc.ins}
          and {\tt xc.ext}.
    \item {\tt xc.ld.hi} and {\tt xc.ld.li} Immediates.
...
{\tt \$COP\_HOME/work/ise\_decode.v}.
This is a file generated automatically from
{\tt \$COP\_HOME/docs/ise\_opcodes.txt}
by
{\tt \$COP\_HOME/bin/ise-parse-opcodes.py}.
...
Though many of the COP instructions are implemented using multi-cycle
FSMs they can still be issued to the COP back to back.
