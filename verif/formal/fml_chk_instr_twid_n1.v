...
`VTX_CHECKER_MODULE_BEGIN(instr_twid_n1)
...
// twid_n1
//
`VTX_CHECK_INSTR_BEGIN(twid_n1) 

    // Result comes from the PACK_WIDTH_ARITH_OPERATION_RESULT macro.
    `VTX_ASSERT_CRD_VALUE_IS(twid_n1_result)

    // Never causes writeback to GPRS
    `VTX_ASSERT_WEN_IS_CLEAR

`VTX_CHECK_INSTR_END(twid_n1)
